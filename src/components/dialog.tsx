...
import { HtCloseOutline } from "../icons/index.js";
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end dark:bg-neutral-600/50",
        className,
      )}
      {...props}
    >
