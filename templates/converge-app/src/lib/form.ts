...
export const isCustomField = <T extends FieldValues>(field: FormField<T>): field is CustomFormField<T> =>
  "custom" in field && field.custom === true;
...
export const isObjectField = <T extends FieldValues>(field: FormField<T>): field is ObjectFormField =>
  "kind" in field && field.kind === "object";
